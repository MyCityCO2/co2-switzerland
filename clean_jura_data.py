...
df = pd.read_excel(path, header=index_header).dropna(axis = 0, how = 'all').dropna(axis = 1, how = 'all') # clean df from empty lines/columns
...
cleaned.columns = ['uid_label', 'uid_city', 'result']
